...
from drc_cmis.client.mapper import (
    CONNECTION_MAP, DOCUMENT_MAP, GEBRUIKSRECHTEN_MAP,
    OBJECTINFORMATIEOBJECT_MAP, REVERSE_CONNECTION_MAP, REVERSE_DOCUMENT_MAP,
    REVERSE_GEBRUIKSRECHTEN_MAP, REVERSE_OBJECTINFORMATIEOBJECT_MAP
)
