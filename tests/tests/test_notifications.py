...
class NotificationTests(DMSMixin, TestCase):
    ...
    def test_notifications_fully_filled(self):
        ...
        APICredential.objects.create(
            api_root="https://ref.tst.vng.cloud/zrc/", label="ZRC", client_id="test", secret="test"
        )
        APICredential.objects.create(
            api_root="https://ref.tst.vng.cloud/ztc/", label="ZTC", client_id="test", secret="test"
        )
    ...
    def test_notifications_no_zaaktype(self):
        ...
        data = {
            ...
            "resource_url": "https://ref.tst.vng.cloud/zrc/api/v1/zaken/random-zaak-uuid",
            "aanmaakdatum": "2018-01-01T17:00:00Z",
            "kenmerken": {"bron": "082096752011", "vertrouwelijkeidaanduiding": "openbaar",},
        }
