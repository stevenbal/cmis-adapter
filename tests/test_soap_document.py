...
class CMISSOAPDocumentTests(DMSSOAPMixin, TestCase):
...
class CMISSOAPContentObjectsTests(DMSSOAPMixin, TestCase):
...
class CMISSOAPFolderTests(DMSSOAPMixin, TestCase):
